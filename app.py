...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4419455394&password=JOBAYAR_CODX-Y4IZGBMMN"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4690141796&password=UDITGAMING_70142"
    else:
        return "uid=4661115126&password=PNX_NAJMI_ADMIN_833QO"
